...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("قناه السورس 📢", url="t.me/Source_Luffy")],[InlineKeyboardButton("تواصل السورس 💬", url="t.me/Luffy_xtbot")],[InlineKeyboardButton("شروحات السورس 📑", url="t.me/Source_Luffy")]])
